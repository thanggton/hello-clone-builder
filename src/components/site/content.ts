...
export const appExamples = [
  ...
  {
    name: "Boo",
    category: "Dating, friendship & chat",
    initial: "Boo",
    color: "#d7efec",
    description:
      "A dating and friendship app that helps people discover compatible matches, chat, and connect through shared interests and personality.",
    url: "https://play.google.com/store/apps/details?id=enterprises.dating.boo&hl=en",
  },
  {
    name: "purp",
    category: "Make friends & chat",
    initial: "p",
    color: "#e8ddfa",
    description:
      "A social app for discovering people around the world, sending friend requests, and starting conversations when you connect.",
    url: "https://play.google.com/store/apps/details?id=com.hubolabs.hubo&hl=en",
  },
];
